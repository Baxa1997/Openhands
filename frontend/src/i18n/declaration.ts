...
export enum I18nKey {
  ...
  INTEGRATIONS$COMING_SOON = "INTEGRATIONS$COMING_SOON",
  INTEGRATIONS$NOTION_DESCRIPTION = "INTEGRATIONS$NOTION_DESCRIPTION",
  INTEGRATIONS$NOTION_API_KEY = "INTEGRATIONS$NOTION_API_KEY",
  INTEGRATIONS$NOTION_DATABASE_ID = "INTEGRATIONS$NOTION_DATABASE_ID",
  INTEGRATIONS$NOTION_HELP_TITLE = "INTEGRATIONS$NOTION_HELP_TITLE",
  INTEGRATIONS$NOTION_HELP_STEP1 = "INTEGRATIONS$NOTION_HELP_STEP1",
  INTEGRATIONS$NOTION_HELP_STEP2 = "INTEGRATIONS$NOTION_HELP_STEP2",
  INTEGRATIONS$NOTION_HELP_STEP3 = "INTEGRATIONS$NOTION_HELP_STEP3",
  INTEGRATIONS$NOTION_USAGE_TITLE = "INTEGRATIONS$NOTION_USAGE_TITLE",
  INTEGRATIONS$NOTION_USAGE_STEP1 = "INTEGRATIONS$NOTION_USAGE_STEP1",
  INTEGRATIONS$NOTION_USAGE_STEP2 = "INTEGRATIONS$NOTION_USAGE_STEP2",
  INTEGRATIONS$NOTION_USAGE_STEP3 = "INTEGRATIONS$NOTION_USAGE_STEP3",
  ...
  INTEGRATIONS$TESTING_CONNECTION = "INTEGRATIONS$TESTING_CONNECTION",
  INTEGRATIONS$TEST_CONNECTION = "INTEGRATIONS$TEST_CONNECTION",
  INTEGRATIONS$CONNECTED = "INTEGRATIONS$CONNECTED",
  INTEGRATIONS$CONNECTION_FAILED = "INTEGRATIONS$CONNECTION_FAILED",
  INTEGRATIONS$SUCCESSFULLY_CONNECTED_TO_NOTION = "INTEGRATIONS$SUCCESSFULLY_CONNECTED_TO_NOTION",
  INTEGRATIONS$FAILED_TO_CONNECT_TO_NOTION = "INTEGRATIONS$FAILED_TO_CONNECT_TO_NOTION",
  INTEGRATIONS$FAILED_TO_TEST_NOTION_CONNECTION = "INTEGRATIONS$FAILED_TO_TEST_NOTION_CONNECTION",
  NOTION$SEARCH_PLACEHOLDER = "NOTION$SEARCH_PLACEHOLDER",
  NOTION$FAILED_TO_LOAD_TASKS = "NOTION$FAILED_TO_LOAD_TASKS",
  NOTION$NO_TASKS_FOUND = "NOTION$NO_TASKS_FOUND",
  NOTION$NO_TASKS_IN_DATABASE = "NOTION$NO_TASKS_IN_DATABASE",
  NOTION$TASKS_COUNT = "NOTION$TASKS_COUNT",
  NOTION$TASKS_COUNT_plural = "NOTION$TASKS_COUNT_plural",
  NOTION$CLOSE = "NOTION$CLOSE",
}
